    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="text-lg font-semibold text-gray-800">November 20, 2025</div>
              </div>
              <div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <p className="text-gray-800 leading-relaxed">
                Client requested a follow-up next week to discuss additional features and pricing options.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Client Contact Information</h2>
            <div className="space-y-4">
              <div className="flex items-start">
                <input
                  type="checkbox"
                ...
                />
                <div>
                  <div className="font-medium text-gray-800">Sarah Mitchell</div>
                  <div className="text-sm text-gray-600">123 main st, sydney</div>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="mt-1 mr-3 w-4 h-4 text-blue-600 focus:ring-blue-500"
                />
                <div className="font-medium text-gray-800">john.doe@email.com</div>
              </div>
            </div>
          </div>
        </div>
